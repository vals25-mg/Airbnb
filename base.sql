...
VALUES ('T1',3,195.0,'../assets/img/Maison1.jpg','Stanford, Afrique du Sud',
...
3);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',1,90.0,'../assets/img/Maison2.jpg','Kiserian, Kenya'
...
,2);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',3,275.0,'../assets/img/Maison3.jpg','Kamala, Thaïlande'
...
,2);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',5,200.0,'../assets/img/Maison4.jpg','Pondichéry, Inde',
...
,4);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',4,230.0,'../assets/img/Maison5.jpg','Plettenberg Bay, Afrique du Sud'
,'Simple and elegant, this architectural masterpiece loves letting the ocean breeze flow through its nature-inspired interiors. Just as easily, you’ll wander freely from inside to out, enjoying the pool deck, fire pit, pizza oven, and of course, the incredible ocean view. Spend the day hiking nearby trails, relaxing on the beach, or shooting pool at home. At night, head into Cape Town for dinner.'
,2);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',2,230.0,'../assets/img/Maison6.jpg','Tofinho, Mozambique'
...
,2);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T1',6,230.0,'../assets/img/Maison7.jpg','La Canée, Grèce'
,'Bedroom 1 - Master: King size bed, Ensuite bathroom with stand-alone rain shower, Television, Safe, Terrace'
,4);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T2',2,75.0,'../assets/img/Appartement1.jpg','Chamonix-Mont-Blanc, France'
...
,1);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T2',3,170.0,'../assets/img/Appartement2.jpg','Pigra, Italie'
...
,2);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T2',4,135.0,'../assets/img/Appartement3.jpg','Mengwi, Indonésie'
...
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T2',2,110.0,'../assets/img/Appartement4.jpg','Black river Maurice'
...
,1);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T3',1,80.0,'../assets/img/Studio1.jpg','Kaş, Turquie'
...
,1);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T3',1,95.0,'../assets/img/Studio2.jpg','Arumeru, Tanzanie'
...
,1);
INSERT INTO habitation (idtype,nombreDeChambre,loyerparjour,image,quartier,description,nblits) 
VALUES ('T3',1,80.0,'../assets/img/Studio3.jpg','Amirim, Israël'
